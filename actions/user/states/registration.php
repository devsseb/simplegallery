<form class="user box" action="?user=registration" method="post">
<? if ($code) : ?>
	<h2><?=l('user.registration.new-password')?></h2>
	<table>
...
<? else : ?>
	...
	<table>
		...
		<tr><th><?=l('user.profil.password')?> :</th><td class="user-field"><input name="password" type="password" /></td></tr>
		<tr><th><?=l('user.profil.password-retype')?> :</th><td class="user-field"><input name="password-check" type="password" /></td></tr>
		<tr><td class="box-submit" colspan="2"><input type="submit" value="<?=l('user.registration.register')?>" /></td></tr>
	</table>
<? endif; ?>
	<div class="box-links">
		<a href="?"><?=l('cancel')?></a>
