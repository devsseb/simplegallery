<form class="box user" action="?user=profil" method="post">
	<h2><?=l('user.profil._')?></h2>
...
<? endif; ?>
		...
		<tr><td class="box-submit" colspan="2"><input type="submit" value="<?=l('user.profil.update')?>" /></td></tr>
	</table>
	<div class="box-links">
		<a href="?"><?=l('cancel')?></a>
	</div>
